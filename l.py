...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.chkSamePath = QtWidgets.QCheckBox(self.centralwidget)
        self.chkSamePath.setObjectName("chkSamePath")
        self.horizontalLayout_2.addWidget(self.chkSamePath)
...
"les fichiers .py sortant"))
        ...
        self.chkSamePath.setText(_translate("MainWindow", "Ui et Py même emplacement"))
